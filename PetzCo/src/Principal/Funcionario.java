...
public class Funcionario extends Contato implements CRUD {
	...
	public void cadastrar() {
		...
		int selecao = JOptionPane.showConfirmDialog(null, comboBox, "Selecione o cargo do profissional: ",
		...
		String colunas = "nome, cpf, telefone, email, dataContratacao, fkEndereco, fkCargoFuncionario";
		String valores = "'" + nome + "','" + cpf + "','" + telefone + "','" + email + "','" + dataContratacaoFormatada
				+ "', '" + fkEndereco + "', '" + fkCargo + "'";

		int idFuncionario = SQLGenerator.insertSQL(tabela, colunas, valores);
		if (idFuncionario > 0) {
			JOptionPane.showMessageDialog(null,
					"Funcionário cadastrado com sucesso! Código do funcionário:  " + idFuncionario);
